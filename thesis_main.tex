...
\usepackage{titling}
\title{MAEPL - A PDDL-based language for compactly representing epistemic
planning tasks}
\author{Lukas Halbritter}

\newcommand{\firstexaminer}{Prof.~Dr.~Bernhard Nebel}
\newcommand{\secondexaminer}{\todo{Zweitkorrektor?}}
\newcommand{\advisers}{Thorsten Engesser}
